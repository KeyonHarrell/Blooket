    // ==UserScript==
    // @name         Keyon and Paul: Blooket Panel
    ...
    * https://github.com/KeyonHarrell/Blooket/blob/main/LICENSE
    */
    ...
    (() => {
            ...
            const guiWrapper = createElement("div", {
                ...
                (gui = createElement("div", {
                    ...
                    createElement("div", {
                        ...
                        innerHTML: "Keyon and Paul: Blooket Panel",
                    ...
                    (cheatContainer = createElement("div", {
                        ...
                        createElement("a", {
                            ...
                            target: "_blank",
                            href: "https://discord.gg/fWwqDcx6pW",
        ...
        let img = new Image;
        img.src = "https://raw.githubusercontent.com/KeyonHarrell/Blooket/main/autoupdate/timestamps/gui.png?" + Date.now();
        ...
        img.onerror = img.onabort = () => {
            ...
            cheat();
            let iframe = document.querySelector("iframe");
            iframe.contentWindow.alert("It seems the Keyon and Paul API is either blocked or down.\n\nIf it's NOT blocked, join the Discord server for updates\nhttps://discord.gg/fWwqDcx6pW\n(The cheat will still run after this alert)")
        }
    })();
    })();
